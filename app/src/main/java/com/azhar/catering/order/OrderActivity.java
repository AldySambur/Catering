...
import com.azhar.catering.history.HistoryAdapter;
...
public class OrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order);  // Pastikan layout ini sesuai
    ...
    private void setInputData() {
        btnCheckout.setOnClickListener(v -> {
            if (totalItems == 0 || totalPrice == 0) {
                ...
                // Start HistoryOrderActivity to show the order history page
                Intent intent = new Intent(OrderActivity.this, HistoryOrderActivity.class);
                startActivity(intent);

                // Optionally finish OrderActivity to remove it from the back stack
                finish();
            }
        });
    }
